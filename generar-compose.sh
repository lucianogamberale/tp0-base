...
function add-client-service() {
  ...
  add-line $compose_filename "      - NOMBRE=Nombre$client_id"
  add-line $compose_filename "      - APELLIDO=Apellido$client_id"
  add-line $compose_filename "      - DOCUMENTO=3090446$client_id"
  add-line $compose_filename "      - NACIMIENTO=1999-03-17"
  add-line $compose_filename "      - NUMERO=757$client_id"
  add-line $compose_filename "    networks:"
  add-line $compose_filename "      - testing_net"
  add-line $compose_filename "    volumes:"
  add-line $compose_filename "      - type: bind"
